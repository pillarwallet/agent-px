...
export function WithdrawModal({ userState, masterAddress, onSuccess }: WithdrawModalProps) {
    ...
    const availableBalance = userState?.marginSummary?.accountValue
        ? parseFloat(userState.marginSummary.accountValue) - parseFloat(userState.marginSummary.totalMarginUsed)
        : 0;
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4 py-4">
                    ...
                    <Button
                        ...
                        disabled={isLoading || !amount || parseFloat(amount) <= 0 || parseFloat(amount) > availableBalance}
                        className="w-full"
                    >
