        ...
        <Card>
            <CardContent className="p-6">
                ...
                <div className="mb-4">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-end gap-x-8 gap-y-4">
                        {/* Current Price */}
                        {currentPrice !== null && (
                        ...
                        {marketData && (
                            <div className="flex flex-wrap items-end gap-x-8 gap-y-2 text-sm">
                                <div>
                                    <div className="text-xs text-muted-foreground underline decoration-dotted decoration-muted-foreground/50 cursor-help mb-0.5">Mark</div>
                                    <div className="font-semibold">${formatNumber(marketData.markPx)}</div>
                                </div>

                                <div>
                                    <div className="text-xs text-muted-foreground underline decoration-dotted decoration-muted-foreground/50 cursor-help mb-0.5">Oracle</div>
                                    <div className="font-semibold">${formatNumber(marketData.oraclePx)}</div>
                                </div>

                                <div>
                                    <div className="text-xs text-muted-foreground mb-0.5">24H Change</div>
                                ...
                                <div>
                                    <div className="text-xs text-muted-foreground mb-0.5">24H Volume</div>
                                    <div className="font-semibold">{formatVolume(marketData.dayNtlVlm)}</div>
                                </div>

                                <div>
                                    <div className="text-xs text-muted-foreground underline decoration-dotted decoration-muted-foreground/50 cursor-help mb-0.5">Open Interest</div>
                                    <div className="font-semibold">${formatNumber(marketData.openInterest, 2)}</div>
                                </div>

                                <div>
                                    <div className="text-xs text-muted-foreground underline decoration-dotted decoration-muted-foreground/50 cursor-help mb-0.5">Funding / Countdown</div>
