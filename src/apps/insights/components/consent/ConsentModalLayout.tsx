...
export const ConsentModalLayout = React.memo(({
    ...
    <div className={`flex flex-col h-full overflow-hidden ${isMobile ? "pb-16" : ""}`}>
      ...
      <div className="shrink-0 flex items-center justify-between p-4 sm:p-6 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground">Consent Required</h1>
      ...
      {/* Tabs */}
      <Tabs defaultValue="consent" className="flex-1 flex flex-col min-h-0 overflow-hidden">
  ...
  return (
    <Dialog open={open} onOpenChange={() => {}}>
      <DialogContent className="max-w-3xl h-[90vh] p-0 gap-0 flex flex-col overflow-hidden">{content}</DialogContent>
    </Dialog>
  );
});
