    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          Before accessing the PillarX Algorithmic Insights service, you must acknowledge the
          following terms and confirm your understanding. Please review all tabs (Consent, Terms of
          Use, Risk Disclosure) and complete the questions below.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          . It does not execute trades, hold funds, or provide personalized financial advice. All
          events are generated algorithmically and presented for educational and informational
          purposes only.
        </p>
      </div>
      ...
      <div className="space-y-4 border-t border-border pt-6">
        <h3 className="text-lg font-semibold text-foreground">Final Agreement</h3>
        <div className="flex items-start space-x-3">
          ...
          />
          <Label htmlFor="final-consent" className="text-sm leading-relaxed cursor-pointer">
            I have reviewed the Consent, Terms of Use, and Risk Disclosure tabs. I understand that
            this service is for informational purposes only and does not constitute financial
            advice. I agree to all terms and conditions and accept full responsibility for any
        ...
        {needsCoolingOffWaiver && (
          <div className="flex items-start space-x-3 mt-4 p-3 bg-muted/50 rounded-md border border-border">
            ...
            />
            <Label htmlFor="cooling-off-waiver" className="text-sm leading-relaxed cursor-pointer">
              <span className="font-semibold">Cooling-Off Period Waiver (UK/EU):</span> I
              acknowledge my right to a 14-day cooling-off period. By requesting immediate access,
              I voluntarily waive this right and agree to begin using the service immediately.
            </Label>
          </div>
        )}
      ...
      <div className="space-y-6 border-t border-border pt-6">
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium text-foreground">
            ...
            <span className="font-semibold">informational events only</span> and does not
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium text-foreground">
            ...
            <span className="font-semibold">at your own risk</span> and acknowledge that you have
            read the Terms of Use and Risk Disclosure?
          </Label>
          <RadioGroup value={q3Answer || ""} onValueChange={setQ3Answer}>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="agree" id="q3-agree" />
              <Label htmlFor="q3-agree" className="font-normal cursor-pointer">
                I agree
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="disagree" id="q3-disagree" />
              <Label htmlFor="q3-disagree" className="font-normal cursor-pointer">
                I do not agree
              </Label>
            </div>
          </RadioGroup>
